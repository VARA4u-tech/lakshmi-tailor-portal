  ...
  "rounded-xl border transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        gold: "bg-card border-accent/30 hover:border-accent hover:shadow-[0_4px_20px_-4px_hsl(43,60%,52%,0.3)]",
        elevated: "bg-card border-border/50 shadow-[0_8px_32px_-8px_hsl(0,0%,0%,0.4)] hover:shadow-[0_20px_40px_-12px_hsl(0,0%,0%,0.5)]",
      },
    },
    defaultVariants: {
      variant: "default",
