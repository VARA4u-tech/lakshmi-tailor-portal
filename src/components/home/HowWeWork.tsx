...
import { CheckCircle2, MessageSquare, Ruler, Scissors, Sparkles, Package, ChevronLeft, ChevronRight } from "lucide-react";
        ...
        steps: [
            {
                icon: MessageSquare,
                title: "Consultation",
                description: "Discuss your vision, preferences, and requirements with our expert designers.",
                details: "We listen carefully to understand your style, occasion, and budget to create the perfect design plan.",
            },
            {
                icon: Ruler,
                title: "Measurement",
                description: "Precise measurements taken to ensure a perfect fit for your body type.",
                details: "Our experienced tailors take detailed measurements using professional techniques for accuracy.",
            },
            {
                icon: Scissors,
                title: "Design & Cutting",
                description: "Expert cutting and pattern making based on your chosen design.",
                details: "Premium fabrics are carefully cut following traditional and modern tailoring methods.",
            },
            {
                icon: Sparkles,
                title: "Stitching & Embroidery",
                description: "Meticulous stitching with attention to every detail and embellishment.",
                details: "Skilled artisans bring your design to life with precision stitching and beautiful embroidery work.",
            },
            {
                icon: CheckCircle2,
                title: "Fitting & Adjustments",
                description: "Trial fitting to ensure perfect fit with necessary adjustments.",
                details: "We fine-tune every detail during fitting sessions to guarantee your complete satisfaction.",
            },
            {
                icon: Package,
        ...
        steps: [
            {
                ...
                details: "పర్ఫెక్ట్ డిజైన్ ప్లాన్ సృష్టించడానికి మీ స్టైల్, సందర్భం మరియు బడ్జెట్ అర్థం చేసుకోవడానికి మేము జాగ్రత్తగా వింటాము.",
            },
            {
                icon: Ruler,
                title: "కొలతలు",
                description: "మీ శరీర రకానికి సరిపోయే ఖచ్చితమైన కొలతలు తీసుకోబడతాయి.",
                details: "మా అనుభవజ్ఞులైన టైలర్లు ఖచ్చితత్వం కోసం వృత్తిపరమైన పద్ధతులను ఉపయోగించి వివరణాత్మక కొలతలు తీసుకుంటారు.",
            },
            {
                icon: Scissors,
                title: "డిజైన్ & కట్టింగ్",
                description: "మీరు ఎంచుకున్న డిజైన్ ఆధారంగా నిపుణుల కట్టింగ్ మరియు ప్యాటర్న్ తయారీ.",
                details: "సాంప్రదాయ మరియు ఆధునిక టైలరింగ్ పద్ధతులను అనుసరించి ప్రీమియం ఫాబ్రిక్స్ జాగ్రత్తగా కత్తిరించబడతాయి.",
            },
            {
                icon: Sparkles,
                title: "స్టిచింగ్ & ఎంబ్రాయిడరీ",
                description: "ప్రతి వివరాలు మరియు అలంకరణకు శ్రద్ధతో జాగ్రత్తగా కుట్టడం.",
                details: "నైపుణ్యం కలిగిన కళాకారులు ఖచ్చితమైన కుట్టు మరియు అందమైన ఎంబ్రాయిడరీ పనితో మీ డిజైన్‌కు జీవం పోస్తారు.",
            },
            {
                icon: CheckCircle2,
                title: "ఫిట్టింగ్ & సర్దుబాట్లు",
                description: "అవసరమైన సర్దుబాట్లతో పర్ఫెక్ట్ ఫిట్ నిర్ధారించడానికి ట్రయల్ ఫిట్టింగ్.",
                details: "మీ పూర్తి సంతృప్తిని హామీ ఇవ్వడానికి ఫిట్టింగ్ సెషన్లలో మేము ప్రతి వివరాన్ని చక్కగా సర్దుబాటు చేస్తాము.",
            },
            {
                icon: Package,
                title: "ఫైనల్ డెలివరీ",
                description: "మీ మాస్టర్‌పీస్ సిద్ధంగా ఉంది! శ్రద్ధ మరియు నాణ్యత హామీతో డెలివరీ చేయబడుతుంది.",
                details: "మీ అందంగా పూర్తి చేసిన దుస్తులను స్వీకరించండి, జాగ్రత్తగా ప్యాక్ చేయబడి ధరించడానికి సిద్ధంగా ఉంది.",
            },
        ],
    },
};
                    ...
                    <div className="relative h-[500px] sm:h-[450px] md:h-[450px] flex items-center justify-center md:perspective-1000 overflow-hidden">
                        {t.steps.map((step, index) => {
                            ...
                            return (
                                ...
                                >
                                    <div className={`bg-card border-2 ${isActive ? 'border-accent shadow-2xl shadow-accent/20' : 'border-border/50'} rounded-2xl p-6 sm:p-8 backdrop-blur-sm transition-all duration-300`}>
                                        {/* Icon */}
                                        <div className={`w-14 h-14 sm:w-16 sm:h-16 rounded-2xl ${isActive ? 'bg-accent' : 'bg-accent/10'} flex items-center justify-center mb-4 sm:mb-6 transition-all duration-300`}>
                                            <step.icon className={`w-7 h-7 sm:w-8 sm:h-8 ${isActive ? 'text-accent-foreground' : 'text-accent'}`} />
                                        </div>
                            ...
                            >
                                <div className="flex flex-col items-center gap-2">
                                    ...
                                    {index < t.steps.length - 1 && (
                                        <div className="absolute left-1/2 w-full h-0.5 -z-10" style={{ maxWidth: `calc(100% / ${t.steps.length})` }}>
                                            <div className={`h-full transition-all duration-500 ${index < currentIndex ? 'bg-accent' : 'bg-muted-foreground/20'
                                                }`} />
                                        </div>
                                    )}

                                    {/* Step label */}
                                    <span className={`text-xs font-medium transition-colors hidden md:block ${index === currentIndex
                                        ? 'text-accent'
