                ...
                {!isPaused && (
                    <div className="absolute top-[-20px] left-0 w-full h-1 bg-white/10 rounded-full overflow-hidden">
                        <div
                            ...
                            style={{ animationDuration: `${AUTO_PLAY_INTERVAL}ms`, animationTimingFunction: 'linear' }}
                        />
                    </div>
                )}
                        ...
                        style={
                            {
                                ...
                                "--opacity":
                                    ((stack.length - 1) - idx) >= 6
                                        ? 0
                                        : 1 - ((stack.length - 1) - idx) * OPACITY_FACTOR,
            ...
            <div className={cn("size-full flex flex-col", hideContent && "invisible")}>
                ...
                <div className="flex-1 p-6 flex flex-col gap-4 relative">
                    ...
                    <div className="border-t border-border/50 pt-4 flex items-center justify-between">
                        ...
                        <Link to="/contact">
                            <Button size="sm" className="bg-accent hover:bg-accent/90 text-accent-foreground font-semibold shadow-gold">
                                Book Now
                            </Button>
                        </Link>
                    </div>
